<div class="p-4">
    <div class="flex justify-between">
        <h5 class="text-lg font-weight-bold">Tolak & <b>Hapus</b> Pembayaran Tiket</h5>
        <button type="button" title="Tutup" wire:click="closeModal()" class="self-start"><i
                class="cil-x"></i></button>
    </div>
    <hr/>
    <form wire:submit.prevent="submit" class="mt-4">
        <p>Apakah anda ingin menolak & <b>mengapus</b>  pembayaran ini?</p>
        <hr class="my-4"/>
        <div class="flex flex-wrap mb-2 justify-end">
            ...
            <div wire:loading>
                ...
                <p class="text-xl">Harap Tunggu</p>
